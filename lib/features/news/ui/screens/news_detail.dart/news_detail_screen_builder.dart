...
import 'package:places_search/features/news/ui/screens/news_detail.dart/news_detail_screen.dart';
import 'package:places_search/features/news/ui/screens/news_detail.dart/news_detail_wm.dart';
...
class NewsDetailScreenBuilder extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Provider<INewsDetailWM>(
      create: (context) => NewsDetailWM(
        context.read<IFavoritesRepository>(),
      ),
      child: Builder(
           builder: (context) {
             return NewsDetailScreen(wm: context.read<INewsDetailWM>());
           },
         ),
    );
  }
